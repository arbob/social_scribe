...
**➡️ [Live Demo](https://social-scribe-app.fly.dev/) ⬅️**
...
* **HubSpot CRM Integration:**
    * Connect your HubSpot account via OAuth to sync meeting insights with your CRM.
    * AI automatically extracts contact information (emails, phone numbers) from meeting transcripts.
    * Search and update HubSpot contacts directly from the meeting details page.
    * Keep your CRM up-to-date with the latest contact details discovered during meetings.
...
* **Connect & Sync:** Users log in with Google. The "Settings" page allows connecting multiple Google accounts, plus LinkedIn, Facebook, and HubSpot accounts. For Facebook, after initial connection, users are guided to select a Page for posting. Calendars are synced to a database to populate the dashboard with upcoming events.
...
* **HubSpot CRM Updates:**
    * From the "Meeting Details" page, users can update HubSpot contacts with information extracted from meeting transcripts.
    * AI analyzes transcripts to find contact emails and phone numbers mentioned during conversations.
    * Search for existing HubSpot contacts and update their records with newly discovered information.
